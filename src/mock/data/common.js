...
export const getSendMsg = req => {
  ...
  return {
    ...
    data: {
      msgCode: (
        1000 + parseInt((Math.random() * 8999).toString(), 10)
      ).toString()
    },
...
export const checkLoginByAccount = req => {
  console.log(
    `%c near-admin %c here mock request %c`,
    'background:#35495e ; padding: 1px; border-radius: 3px 0 0 3px;  color: #fff',
    'background:#dbaf05 ; padding: 1px; border-radius: 0 3px 3px 0;  color: #fff',
...
export const checkLoginByPhone = req => {
  console.log(
    `%c near-admin %c here mock request %c`,
    'background:#35495e ; padding: 1px; border-radius: 3px 0 0 3px;  color: #fff',
    'background:#dbaf05 ; padding: 1px; border-radius: 0 3px 3px 0;  color: #fff',
