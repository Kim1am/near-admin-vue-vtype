...
const prodConfig = {
  ...
  plugins: [
    ...
    new webpack.ProvidePlugin({
      dict: [
        path.resolve(path.join(__dirname, 'src/assets/js/custom/dict.js')),
        'default'
      ],
      comConfig: [
        path.resolve(path.join(__dirname, 'src/assets/js/custom/config.js')),
        'default'
      ]
    })
  ],
...
const vueConfig = {
  ...
  chainWebpack: config => {
    ...
    config.resolve.alias
      ...
      .set('@locale', path.resolve('src/assets/js/locale'))
      .set('@corejs', path.resolve('src/core/assets/js'))
      .set('@corecp', path.resolve('src/core/components'))
      .set('@custom', path.resolve('src/assets/js/custom'))
